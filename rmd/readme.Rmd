...
- area: surface area of section based on width and total section length
- area_pool: surface area of pool based on width and length of that 
- area_riffle: surface area of riffle based on width and length
- area_run: surface area of run based on width and length
- area_ucb: surface area of undercut bank based on width and length (renamed as habitat refuge area (HRA) in manuscript)

## Formatting Capture-Recapture Data ('format_cmr.R')
