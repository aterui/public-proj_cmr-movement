...
\subsection*{Proportional abundance of all captured fish species}
...
%\subsection*{Median length at capture of tagged species}
...
\subsection*{Distribution of movement by each species per season}

\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{output/fig_total_move.pdf}
    \caption{The frequency of movement for each target species shown for both winter and summer seasons. Fine-scale movement is prevalent despite seasonality, but follows a leptokurtic distribution.}
