...
In addition, by including non-recaptured individuals as a recapture state ($Y_i = 0$), the model can still use the partial movement information from those not recaptured.
