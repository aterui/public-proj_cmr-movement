...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{CMR_site.pdf}
    \caption[Location and schematic of the stream reach.]{Panel A shows the location of the stream reach within the Piedmont of North Carolina, USA. Panel B is a picture of the stream for reference. Panel C is a schematic of the stream reach. Mark-recapture was conducted in the 430m reach, broken down by 10m sections. Sections consisted of pool-riffle sequences. Each section was sampled using single-pass backpack electrofishing.}
    \label{CMR_site}
\end{figure}
...
Proportional abundance for each of these species can be found in Appendix Figure B.1.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{fig_est.pdf}
...
These results were summarized in the Appendix Table C.2.
...
First, smaller green sunfish could serve as prey for larger bluehead chub. Yet, despite the omnivorous nature of bluehead chub \cite{tracyBlueheadChubNocomis2009}, there is little evidence describing bluehead chub preying upon other fish, making it difficult to envision them preferentially targeting sunfish, which possess spiny fins, over other potential prey items like algae and invertebrates. Second, both species might respond to shared environmental cues, such as increased microhabitat availability \citep{careyEffectsLittoralHabitat2010}.
...
All data and R code can be found on the Zenodo repository under the following link: \url{https://doi.org/10.5281/zenodo.17870952}
...
This work is based on materials supported by University of North Carolina at Greensboro Startup, the Faculty Internal Award, John O'Brien Ecological Field Award, and Dorothy Levis Munroe Research Award funds. We graciously thank our undergraduate students for their help in conducting seasonal fieldwork and digitizing data. We are grateful to University of North Carolina at Greensboro and North Carolina Agricultural and Technical State University for their cooperation in granting us access to Gateway Research Park. This study was conducted in accordance with approval from the Institutional Animal Care and Use Committee at University of North Carolina at Greensboro (protocol numbers 20-003 and 2022-1173).
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{fig_abundance.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{fig_total_move.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{fig_size_dist.pdf}
